...
class ChartVariance extends StatefulWidget {
  final FinanceModel finance;
  const ChartVariance({super.key, required this.finance});

  @override
  State<ChartVariance> createState() => _ChartVarianceState();
}

class _ChartVarianceState extends State<ChartVariance> {
